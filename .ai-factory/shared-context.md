...
### Module Dependencies (import graph)
  ...
  pages/Home.tsx → imports: components/ScreenScaffold, components/BottomCTA, components/StateView, lib/storage, lib/validation, lib/fire, lib/utils, lib/types
  pages/Result.tsx → imports: components/ScreenScaffold, components/BottomCTA, components/StateView, components/Card, components/SummaryHero, components/MiniBar, components/AssetChart, components/RewardGate, components/ScenarioCompare, lib/fire, lib/share, lib/utils, lib/types
...
export type FireResult = { isAchievable: boolean; yearsToFire: number; targetAssets: number; finalAssets: number; annualRetirementIncome: number; scenarioId?: string; calculatedAt: string };
export type Scenario = { id: string; name: string; input: UserInput; result: FireResult; createdAt: string };
export type calculateFireFn = (input: UserInput)
